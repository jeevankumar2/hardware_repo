...
void R_TAU0_Create(void)
{
    ...
    TPS0 = _0003_TAU_CKM0_FCLK_3 | _0080_TAU_CKM1_FCLK_8 | _0000_TAU_CKM2_FCLK_1 | _0000_TAU_CKM3_FCLK_8;
    /* Stop all channels */
