...
#define _0200_CSI20_DIVISOR              (0x0200U)
#define _9E00_IIC21_DIVISOR              (0x9E00U)
#define IIC21_WAITTIME                   (160U) /* change the waiting time according to the system */
#define _10_IICA0_MASTERADDRESS          (0x10U)
#define _4D_IICA0_IICWH_VALUE            (0x4DU)
#define _54_IICA0_IICWL_VALUE            (0x54U)
